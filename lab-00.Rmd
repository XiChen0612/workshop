...
```{r setup-tibble}
team_data <- tibble(
  name = c("Emma", "Yankun", "TANKI", 
           "Hani", "Hezhen Wang"),
  github_username = c("taoran06", "Shuangyk", "TANKIzzz", 
                      "haniman26", "HEZHENWANG"), 
  colour = c("blue", "blue", "yellow", 
             "white", "blue"),
  hobby = c("singing", "gaming", "soccer", 
            "solving puzzles", "football"),
  favourite_number = c(3, 5, 7, 6, 6)
  )
